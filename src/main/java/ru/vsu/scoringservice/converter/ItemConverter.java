...
public class ItemConverter {
    public Item convertPerson(Person person) {
        var item = new Item();
        /*item.setAttribute("checking_status", String.valueOf(person.getCheckingStatus()));
